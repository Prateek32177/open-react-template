...
function Header() {
  ...
  return (
    <header className="fixed w-full z-30" style={{background: "#151719",filter: "drop-shadow(2px 4px 6px black)"}}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4" >
            {/* Logo */}
            <Link to="/" style={{display:"flex"}} className="block" aria-label="Cruip">
